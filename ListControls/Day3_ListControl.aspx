<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Day3_ListControl.aspx.cs" Inherits="Day3_ListControl" %>
...
<body>
    <form id="form1" runat="server">
        <div class="container">
            <div class="row">
                <h1 align="center">Day3 _ List Controls</h1><hr />
                <div>
            ...
            <hr />
            <div class="col-md-4">
                <asp:ListBox ID="lstbOriginalList" runat="server" ViewStateMode="Enabled" SelectionMode="Multiple" ></asp:ListBox><br /><br />
            ...
            <div class="col-md-4">
                <asp:ListBox ID="lstbCopyList" runat="server" SelectionMode="Multiple" ></asp:ListBox>
            </div>
            </div>
        </div>
    </form>
