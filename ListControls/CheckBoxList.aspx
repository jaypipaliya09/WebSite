<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CheckBoxList.aspx.cs" Inherits="ListControls_CheckBoxList" %>
...
<body>
    <form id="form1" runat="server">
        <div class="container">
            <div class="row">
                <h1 align="center">CheckBox List</h1><hr />
                <div>
            ...
            <hr />
            <div class="col-md-4">
                <asp:CheckBoxList ID="cblOriginalList" runat="server" ViewStateMode="Enabled" ></asp:CheckBoxList><br /><br />
            ...
            <div class="col-md-4">
                <asp:CheckBoxList ID="cblCopyList" runat="server" ></asp:CheckBoxList>
            </div>
            </div>
        </div>
    </form>
