<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RadioList.aspx.cs" Inherits="ListControls_RadioList" %>
...
<body>
    <form id="form1" runat="server">
        <div class="container">
            <div class="row">
                <h1 align="center">RadioButton List</h1><hr />
                <div>
            ...
            <hr />
            <div class="col-md-4">
                <asp:RadioButtonList ID="rblOriginalList" runat="server" ViewStateMode="Enabled" ></asp:RadioButtonList><br /><br />
            ...
            <div class="col-md-4">
                <asp:RadioButtonList ID="rblCopyList" runat="server" ></asp:RadioButtonList>
            </div>
            </div>
        </div>
    </form>
